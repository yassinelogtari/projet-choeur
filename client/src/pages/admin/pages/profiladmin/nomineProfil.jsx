    ...
    const fetchEliminatedMembers = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8000/api/profile/listedesnomines"
        );
        const eliminatedList = response.data.nominatedMembers;
  ...
  return (
    <div className="position-absolute top-50 start-50 translate-middle exlurechordiv">
      <div className="title-button-container">
        <div className="titreprofil">Liste des nominés</div>
